...
public class AddPerformance implements ActionListener {
	...
	public void eventAddPerformance(int month, int day, String time,int cost)
	{
		...
		performances.add(new Performance(0, ProgramGUI.getInstance().getHost(), performanceName.getText(), new java.sql.Date(temp.getTime()), new java.sql.Time(t.getTime()),cost));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o==ok)
		{
			...
			eventAddPerformance(monthdata[monthBox.getSelectedIndex()],daydata[dayBox.getSelectedIndex()],timestamp[timeBox.getSelectedIndex()],Integer.parseInt(costTextfield.getText()));
